...
var tool={
      ...
      //  var maptype = localStorage.getItem("maptype");
        ...
        if(maptype=='air'){
            ...
            if(type=="city"){
                ...
                // }
                // console.log(name)
                var stationName=item.CITYNAME
                if(item.type=="province"){
                    stationName=item.COUNTYNAME
                }
                console.log(stationName)
                console.log(item)

                //menuFunction.changeToCityPage(10011)//functionName方法
              ...
              /*  var iw = new BMap.InfoWindow("<b class='iw_poi_titlecity3' title='"+item.CITYNAME+"' onclick='"+functionName+"'>"+city+item.CITYNAME+"</b><div class='iw_poi_content' onclick='"+functionName+"'><i class='iconApp-Warning'></i></div>");
                ...
                if(stationName.length<=3){
                    var iw = new BMap.InfoWindow("<div class='iw_poi_titlecity5' title='"+item.CITYNAME+"' onclick='"+functionName+"'>"+stationName+"</div><div class='iw_poi_contentcity1' onclick='"+functionName+"'><i class='iconApp-Warning'></i></div>");
                }
                else if(stationName.length==4){
                    var iw = new BMap.InfoWindow("<div class='iw_poi_titlecity4' title='"+item.CITYNAME+"' onclick='"+functionName+"'>"+stationName+"</div><div class='iw_poi_contentcity1' onclick='"+functionName+"'><i class='iconApp-Warning'></i></div>");
                }else if(stationName.length>=5){
                    var iw = new BMap.InfoWindow("<b class='iw_poi_titlecity3' title='"+item.CITYNAME+"' onclick='"+functionName+"'>"+stationName+"</b><div class='iw_poi_content' onclick='"+functionName+"'><i class='iconApp-Warning'></i></div>");
                }
                // var iw = new BMap.InfoWindow("<div class='iw_poi_titlecity4' title='"+item.CITYNAME+"' onclick='"+functionName+"'>"+stationName+"</div><div class='iw_poi_contentcity1' onclick='"+functionName+"'><i class='iconApp-Warning'></i></div>");
             }
    ...
    levelReturn:function(type,value){
        if(value=="—" || value=="-" || value==null || value=="" || value=="质控" || value=="未发布"){
            return "0";
        }else{
    ...
    /*说明中的切换效果*/
    instructionsMenu:function(pageid){
        $("#"+pageid).find(".spanActive").unbind().click(function(){
            $(".spanActive").removeClass("spanShow");
