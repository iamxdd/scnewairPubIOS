...
var menuFunction={
    ...
    indexPage_init:function(){
        ...
        $("#indexGasChangeBar").children("div").unbind().click(function(){
            ...
            menuFunction.indexPage_mapMark();
        });
        sessionStorage.setItem("allCityChange","1")
    ...
    indexPage_mapMark:function(){
        ...
        // else if(maptypeStatu == 'env'){
        //     envmap.addEventListener("zoomend", function(){
        //         var zoomindex = this.getZoom();
        //         getGas(zoomindex)
        //     });
        //     getGas(7);
        //     function getGas(zoomindex) {
        //         envmap.clearOverlays();
        //         menuFunction.getBoundaty(envmap);
        //         if(zoomindex>=8 || zoomindex<7){
        //             if(zoomindex>=8){
        //                 $("#indexPageType").fadeIn()
        //             }else {
        //                 $("#indexPageType").fadeOut()
        //             }
        //             config1.http('','post',{},function (data) {
        ...
        //                     var color=tool.levelColor(level);
        //                     itemEach.COLOR=color;
        //                     tool.mapAddMark(envmap,itemEach,"menuFunction.changeToCityPage("+itemEach.CITYCODE+")","city",item.type,zoomindex);
        //                 })
        //             })
        //         }else if (zoomindex>=7 && zoomindex<8){
        //             $("#indexPageType").fadeOut()
        //             if(localStorage.code=="5100"){
        //                 config1.http1('/publish/getAllCityRealTimeAQIC','post',{},function (data) {
        //                     $("#ajaxPleaseWait").hide();
        ...
        //                                 itemEach.COLOR=color;
        //                                 sessionStorage.setItem("siteDetailType","air")
        //                                 tool.mapAddMark(envmap,itemEach,"menuFunction.changeToCityPage("+itemEach.CITYCODE+")","city"," ",zoomindex);
        //                             }
        //                         });
        //                     });
        //                 })
        ...
        //                     var envmapdata=data.columns.STATIONREALTIMEAQI.data;
        //                     $.each(envmapdata,function(i,item){
        //                         var itemEach={};
        ...
        //                         var color=tool.levelColor(level);
        //                         itemEach.COLOR=color;
        //                         tool.mapAddMark(envmap,itemEach,"","station","",zoomindex);
        //                     });
        //                 })
        //             }
        //         }
    ...
    cityPage_createPage:function(citycode){
        ...
        if(siteDetailType == "air"){
            ...
            $("#cityPage_Content5").show();
            $("#cityPage_Content6").show();
            $("#cityGasTable").show();
    ...
    Abnormal_init:function(){
        ...
        var typeChooseBarStatus = sessionStorage.getItem('typeChooseBarStatus')
    ...
    dataAbnormalSubPage_init: function(){
        ...
        $("#typeChooseBar1").find("div").unbind().click(function(){
    ...
    SubPage_init:function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.map(countryObj,function(data,index){
                    var timepoint = data.TimePoint.substring(0,10);
                    var stationname = data.Area+data.StationName;
                    var id = data.id;
                    idarr.push(id);
                    var div=$("<div class='outlierdataTable' id='"+id+"'></div>");
                    var timepointdiv=$("<div class='stationtimepoint'>"+timepoint+"</div>");
                    var stationnamediv=$("<div class='stationname'>"+stationname+"</div>");
                    div.append(timepointdiv)
            ...
            complete:function(XMLHttpRequest){
                ...
                $.each(data.data,function(i,item){
                    ...
                    if(item.CITYCODE==citycode){
                        ...
                        countyStationName=[];
                        $.each(item.STATIONTYPES,function(j,itemj){
                            if(itemj.STATIONTYPECODE==1 || itemj.STATIONTYPECODE==2){
                        ...
                        for(var j=0;j<codearr1.length;j++){
                            $.ajax({
                                ...
                                dataType:'json',
                                async:true,
                                data:{"type":4,"gaslist":"AQI","cityCode":citycode,"userId":2,"area":"'"+codearr1[j]+"'"},
                                error:function(){$("#ajaxPleaseWait").hide();
                                    tool.warningAlert("warAFailed","获取信息失败");
                                },
                                complete:function(XMLHttpRequest){
                                    ...
                                    if(stationcount1==stationlimit1){
                                        for(var k=0;k<codearr2.length;k++){
                                            $.ajax({
                                                ...
                                                dataType:'json',
                                                async:true,
                                                data:{"type":4,"gaslist":"AQI","cityCode":citycode,"userId":2,"area":"'"+codearr2[k]+"'"},
                                                error:function(){$("#ajaxPleaseWait").hide();
                                                    tool.warningAlert("warAFailed","获取信息失败");
                                                },
                                                complete:function(XMLHttpRequest){
                                                    ...
                                                    if(stationcount2==stationlimit2){
                                                        ...
                                                        for(var a=0;a<codearr1.length;a++){
                                                            $.ajax({
                                                                ...
                                                                dataType:'json',
                                                                async:true,
                                                                data:{"type":4,"gaslist":"AQI","cityCode":citycode,"userId":2,"area":"'"+codearr1[a]+"'"},
                                                                error:function(){$("#ajaxPleaseWait").hide();
                                                                    tool.warningAlert("warAFailed","获取信息失败");
                                                                },
                                                                complete:function(XMLHttpRequest){
                                                                    ...
                                                                    if(stationcount1==stationlimit1){
                                                                        for(var d=0;d<codearr2.length;d++){
                                                                            $.ajax({
                                                                                ...
                                                                                dataType:'json',
                                                                                async:true,
                                                                                data:{"type":4,"gaslist":"AQI","cityCode":citycode,"userId":2,"area":"'"+codearr2[d]+"'"},
                                                                                error:function(){$("#ajaxPleaseWait").hide();
                                                                                    tool.warningAlert("warAFailed","获取信息失败");
                                                                                },
                                                                                complete:function(XMLHttpRequest){
    ...
    forePubPage_init:function(){
        var d = new Date();
        // console.log("new d",d)
        // console.log("new d.getH",d.getHours())
        if (d.getHours() <= 16) {
            d.setDate(d.getDate() - 1);
            var today=new Date();
        ...
        // console.log(" d.setDate(d.getDate() - 1)",d)
        d.setHours(0);
        d.setMinutes(0);
        d.setSeconds(0);
        d.setMilliseconds(0);
        // console.log("set d",d)
        // console.log("set d.getTime",d.getTime())
